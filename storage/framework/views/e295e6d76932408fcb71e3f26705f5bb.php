...
<?php $__env->startSection('title', 'Penerimaan Mahasiswa Baru - UMBK'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="hero-slider">
            <div class="hero-slide active">
                <div class="container hero-container">
                    ...
                    <div class="hero-image">
                        <img src="<?php echo e(asset('images/hero1.png')); ?>" alt="Mahasiswa UMBK" class="img-responsive">
                    </div>
                </div>
            </div>
            <div class="hero-slide">
                <div class="container hero-container">
                    ...
                    <div class="hero-image">
                        <img src="<?php echo e(asset('images/hero2.png')); ?>" alt="Mahasiswa UMBK" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="quick-links">
        <div class="container">
            <div class="links-grid">
                <div class="link-card">
                    <a href="<?php echo e(route('program-studi.index')); ?>">
                ...
                <div class="link-card active">
                    ...
                    <h3><a href="<?php echo e(route('register')); ?>">Daftar Sekarang</a></h3>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="why-umbk">
        <div class="container">
            ...
            <div class="why-content">
                <div class="why-image">
                    <img src="<?php echo e(asset('images/building.png')); ?>" alt="Gedung UMBK" class="rounded-img img-responsive">
                </div>
                <div class="why-list">
                    <div class="why-item">
        ...
        <div class="container">
            ...
            <div class="programs-grid">
                <div class="program-card">
                    ...
                    <a href="<?php echo e(route('program-studi.show', 'teknik-informatika')); ?>" class="program-link">Lihat Detail ⟶</a>
                </div>
                <div class="program-card">
                    ...
                    <a href="<?php echo e(route('program-studi.show', 'ilmu-komunikasi')); ?>" class="program-link">Lihat Detail ⟶</a>
                </div>
                <div class="program-card">
                    ...
                    <a href="<?php echo e(route('program-studi.show', 'ekonomi-islam')); ?>" class="program-link">Lihat Detail ⟶</a>
                </div>
                <div class="program-card">
                    ...
                    <a href="<?php echo e(route('program-studi.show', 'ekonomi-pembangunan')); ?>" class="program-link">Lihat Detail ⟶</a>
                </div>
                <div class="program-card">
                    ...
                    <a href="<?php echo e(route('program-studi.show', 'akuntansi')); ?>" class="program-link">Lihat Detail ⟶</a>
                </div>
                <div class="program-card">
                    ...
                    <a href="<?php echo e(route('program-studi.show', 'manajemen')); ?>" class="program-link">Lihat Detail ⟶</a>
                </div>
                <div class="program-card">
                    ...
                    <a href="<?php echo e(route('program-studi.show', 'psikologi')); ?>" class="program-link">Lihat Detail ⟶</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="fees-content text-center">
                ...
                <div class="fees-action">
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary"><i class="fas fa-file-signature"></i> Daftar Sekarang</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="cta-bar">
        <div class="container">
            <h2><a href="<?php echo e(route('register')); ?>">DAFTAR SEKARANG</a></h2>
        </div>
    </section>
    ...
    <section class="flow" id="alur-pendaftaran">
        <div class="container">
            ...
            <div class="flow-image-container">
                <img src="<?php echo e(asset('images/alur-pendaftaran.png')); ?>" alt="Alur Pendaftaran" class="img-responsive">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="info-grid">
                ...
                <div class="info-box qr-section">
                    ...
                    <br><br>
                    <img src="<?php echo e(asset('images/qr-code.png')); ?>" alt="Scan Me" class="qr-img">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="partners">
        <div class="container">
            ...
            <div class="flow-image-container">
                <img src="<?php echo e(asset('images/mitra.png')); ?>" alt="Partner" class="img-responsive">
            </div>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Documents\trae_projects\umbk\resources\views/landing/index.blade.php ENDPATH**/ ?>