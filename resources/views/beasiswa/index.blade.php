...
@section('title', 'Program Beasiswa - PMB UMBK')
            ...
            <div class="beasiswa-grid">
                ...
                <div class="beasiswa-card">
                    ...
                    <div class="beasiswa-content">
                        ...
                        <a href="{{ route('beasiswa.show', 'hafidz') }}" class="beasiswa-link">Selengkapnya ⟶</a>
                    </div>
                </div>
                ...
                <div class="beasiswa-card">
                    ...
                    <div class="beasiswa-content">
                        ...
                        <a href="{{ route('beasiswa.show', 'karawang-cerdas') }}" class="beasiswa-link">Selengkapnya ⟶</a>
                    </div>
                </div>
                ...
                <div class="beasiswa-card">
                    ...
                    <div class="beasiswa-content">
                        ...
                        <a href="{{ route('beasiswa.show', 'kip-kuliah') }}" class="beasiswa-link">Selengkapnya ⟶</a>
                    </div>
                </div>
                ...
                <div class="beasiswa-card">
                    ...
                    <div class="beasiswa-content">
                        ...
                        <a href="{{ route('beasiswa.show', 'mitra-zis') }}" class="beasiswa-link">Selengkapnya ⟶</a>
                    </div>
                </div>
                ...
                <div class="beasiswa-card">
                    ...
                    <div class="beasiswa-content">
                        ...
                        <a href="{{ route('beasiswa.show', 'persyarikatan') }}" class="beasiswa-link">Selengkapnya ⟶</a>
                    </div>
                </div>
                ...
                <div class="beasiswa-card">
                    ...
                    <div class="beasiswa-content">
                        ...
                        <a href="{{ route('beasiswa.show', 'prestasi') }}" class="beasiswa-link">Selengkapnya ⟶</a>
                    </div>
                </div>
                 ...
                 <div class="beasiswa-card">
                    ...
                    <div class="beasiswa-content">
                        ...
                        <a href="{{ route('beasiswa.show', 'tahfidz') }}" class="beasiswa-link">Selengkapnya ⟶</a>
                    </div>
                </div>
