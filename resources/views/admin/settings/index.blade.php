...
@section('title', 'Pengaturan - Admin PMB UMBK')
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('admin.settings.pmb') }}" class="btn btn-primary">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('admin.settings.system') }}" class="btn btn-info">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('admin.settings.maintenance') }}" class="btn btn-warning">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.settings.cache') }}" class="btn btn-outline-primary w-100">
                                <i class="fas fa-broom me-2"></i>Clear Cache
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.settings.backup') }}" class="btn btn-outline-success w-100">
                                <i class="fas fa-database me-2"></i>Backup Data
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ route('admin.settings.logs') }}" class="btn btn-outline-info w-100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="badge bg-info">{{ config('app.debug') ? 'ON' : 'OFF' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        <div class="col-4">
                            <h6 class="text-primary">{{ number_format($usedSpace / 1024 / 1024 / 1024, 2) }} GB</h6>
                            <small class="text-muted">Used</small>
                        </div>
                        <div class="col-4">
                            <h6 class="text-success">{{ number_format($freeSpace / 1024 / 1024 / 1024, 2) }} GB</h6>
                            <small class="text-muted">Free</small>
                        </div>
                        <div class="col-4">
                            <h6 class="text-info">{{ number_format($totalSpace / 1024 / 1024 / 1024, 2) }} GB</h6>
